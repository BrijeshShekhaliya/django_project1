...
urlpatterns = [
    ...
    path('donor/pending-donations/', views.pending_donation_donor, name='pending_donation_donor'),
    path('donor/rejected-donations/', views.rejected_donation_donor, name='rejected_donation_donor'),
    path('donor/accepted-donations/', views.accepted_donation_donor, name='accepted_donation_donor'),
    path('donor/delivered-donations/', views.delivered_donation_donor, name='delivered_donation_donor'),
